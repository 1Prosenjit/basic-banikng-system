    ...
    else if($amount > $sql1['balance']) 
    {
        ...
        echo '</script>';
         ...
         echo "</script>";
                ...
                $sql = "INSERT INTO transactiondetails (`sender`, `receiver`, `balance`) VALUES ('$sender','$receiver','$amount')";
                $query=mysqli_query($conn,$sql);
...
<body style="background-color : #39a5d4 ;">
